# shopify_supplements_enrichment/internal_enricher.py
...
def run_internal_enrichment():
    ...
    # Define paths based on workspace root
    ...
    # ==========================================
    # DOMAIN 1: PRICING & VOLATILITY ENRICHMENT
    # ==========================================
    print("[*] Computing Pricing Enrichments...")
    
    # Calculate historical price metrics per SKU/Variant across snapshots
    ...
    # ==========================================
    # DOMAIN 2: DISCOUNT & BUNDLE ENRICHMENT
    # ==========================================
